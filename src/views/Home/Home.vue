  ...
  <section class="Home pt-4 sm:pt-6">
    <Alert class="pt-0 pb-2 sm:py-4">
      ...
      <AlertDescription class="p-0 text-xs sm:text-sm">
        ...
        <p>SKY-ImageHost免费图床 是 <a class="text-slate-400" href="https://www.it6l.com" target="_blank" title="数科云官方网站">数科云官方网站</a> 支持并维护的文件上传项目，致力于为用户提供稳定的永久存储服务。</p>
        <p style="font-weight: bold">开源地址: <a class="text-[#0969da]" href="https://github.com/0000070/ZYCS-IMG" target="_blank">SKY-ImageHost免费图床</a></p>
      </AlertDescription>
    </Alert>
